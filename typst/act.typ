...
Общая стоимость выполненных работ, оказанных услуг в российских рублях: #num(act_sum) (#ru-words(act_sum)) 00 копеек. Заказчик не имеет претензий по срокам, качеству и объёму товаров и услуг
